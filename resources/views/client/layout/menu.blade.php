          ...
          <ul class="nav navbar-nav">
                                    ...
                                    <ul>
                                      @foreach ($category->child as $childCategory)
                                         ...
                                         <li><a href="category.html">{{ $childCategory->title }}
                                          ...
                                          @if ($childCategory->child->count() > 0)
                                          ...
                                          <div class="dropdown-menu">
                                            <ul>
                                            @foreach ($childCategory->child as $kids)
                                               
                                              <li><a href="category.html">{{ $kids->title }}</a></li>
            ...
            <li class="menu_brands dropdown"><a href="#">برند ها</a>
              <div class="dropdown-menu">
                ...
                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ str_replace('public' , '/storage' , $brand->image) }}" title="{{ $brand->name }}" alt="{{ $brand->name }}" width="100" /></a><a href="#">{{ $brand->name }}</a></div>
