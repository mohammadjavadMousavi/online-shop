      ...
      <div class="row">
        ...
        <div class="col-sm-9" id="content">
          ...
          <form class="form-horizontal" action="{{ route('client.register.verifyOtp',$user) }}" method="post">
            ...
            <fieldset id="account">
              <legend>لطفا ایمیل خود را چک کنید و کد دریافت شده را وارد فیلد زیر کنید</legend>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="input-email" placeholder="کد را وارد کنید" value="" name="code">
                </div>
              </div>
