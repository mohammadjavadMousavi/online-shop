        ...
        <div id="content" class="col-sm-9">
          <div itemscope itemtype="http://schema.org/محصولات">
            ...
            <div class="row product-info">
              <div class="col-sm-6">
                <div class="image"><img class="img-responsive" itemprop="image" id="zoom_01" src="{{ str_replace('public','/storage',$product->image) }}" title="لپ تاپ ایلین ور" alt="لپ تاپ ایلین ور" data-zoom-image="image/product/macbook_air_1-500x500.jpg" /> 
                </div>
                ...
                <div class="image-additional" id="gallery_01">
                  ...
                  <a class="thumbnail" href="#" data-zoom-image="{{ str_replace('public','/storage',$pictures->path) }}" data-image="{{ str_replace('public','/storage',$pictures->path) }}" title="لپ تاپ ایلین ور">
                				<img src="{{ str_replace('public','/storage',$pictures->path) }}" title="لپ تاپ ایلین ور" alt="لپ تاپ ایلین ور" />
                  </a>
              ...
              <div class="col-sm-6">
                ...
                <ul class="price-box">
                  <li class="price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                    ...
                    <span itemprop="price">{{ $product->price_with_discount }}تومان
                ...
                <div id="product">
                  ...
                  <div class="cart">
                    ...
                    <div>
                      <button type="button" id="like-{{ $product->id }}" class="wishlist" onClick="like({{ $product->id }});"><i class="fa fa-heart @if ($product->likes_has) like @endif"></i> افزودن به علاقه مندی ها
                      </button>
                      <br />
            ...
            <div class="tab-content">
              ...
              <div id="tab-review" class="tab-pane">
                  ...
                  @endauth
                   ...
                   <form action="{{ route('client.product.comment.store',$product) }}" method="post">
                      ...
                      <div class="form-group required">
                        ...
                        <div class="form-group required mr-4">
