      ...
      <div class="row">
        ...
        <div id="content" class="col-sm-9">
          ...
          <div class="slideshow single-slider owl-carousel">
            ...
            <div class="item"> <a href="{{ $slide->link }}"><img width="850" height="300" class="img-responsive" src="{{ str_replace('public','/storage',$slide->image) }}" alt="banner 1" /></a> </div>
          ...
          <div class="category-module" id="latest_category">
            ...
            <div class="category-module-content">
              <ul id="sub-cat" class="tabs">
               @foreach ($featuredCategory->child as $subCategory)
                ...
                <div class="owl-carousel latest_category_tabs">
                 @foreach ($subCategory->products as $product)
                  ...
                  <div class="product-thumb">
                    <div class="image"><a href="{{ route('client.product.show',$product) }}"><img src="{{ str_replace('public','/storage',$product->image) }}" alt="تبلت ایسر" title="تبلت ایسر" class="img-responsive" /></a></div>
                    <div class="caption">
                      <h4><a href="{{ route('client.product.show',$product) }}">{{ $product->name }}</a></h4>
                      <p class="price"> 
                        <span class="price-new">{{ $product->price_with_discount }} تومان</span> 

                        @if ($product->has_discount)
                        <span class="price-old">{{ $product->price }} تومان</span> <span class="saving">-{{ $product->discount_value }}%</span> 
                    ...
                    <div class="button-group">
                      ...
                      <div class="add-to-links">
                        <button type="button" id="like-{{ $product->id }}" class="wishlist" onClick="like({{ $product->id }});"><i class="fa  fa-heart @if ($product->likes_has) like @endif"></i>
                        </button>
...
@if (count($category->getSubChildrenCategory()) > 0)
	

          <h3 class="subtitle"> {{ $category->title }} - <a class="viewall" href="category.html">نمایش همه</a></h3>
          <div class="owl-carousel latest_category_carousel">

          	@foreach ($category->getSubChildrenCategory() as $product)
          		 {{--  <div class="product-thumb">
                    <div class="image"><a href="{{ route('client.product.show',$product)}}"><img src="{{ str_replace('public','/storage',$product->image) }}" alt="کرم مو آقایان" title="کرم مو آقایان" class="img-responsive" /></a>
                    </div>
                  <div class="caption">
 ...
 --}}
                <div class="owl-item" style="width: 170px;"><div class="product-thumb">
              ...
              <div class="button-group">
                <button class="btn-primary" type="button" onclick="addToCart({{ $product->id }});"><span>افزودن به سبد</span></button>
                <div class="add-to-links">
                        <input style="display: none;" type="text" name="quantity" value="1" size="2" id="input-quantity{{ $product->id }}" class="form-control" />

                    <button type="button" id="like-{{ $product->id }}" class="wishlist" onClick="like({{ $product->id }});"><i class="fa fa-heart @if ($product->likes_has) like @endif"></i>
                    </button>

                  <button type="button" data-toggle="tooltip" title="" onclick="" data-original-title="افزودن به مقایسه"><i class="fa fa-exchange"></i></button>
                </div>
              </div>
            </div></div>
