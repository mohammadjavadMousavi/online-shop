		    ...
		    <div class="box">
		        ...
		        <div class="box-body">
		        	<form action="{{ route('role.update',$roles) }}" method="post">
		        			...
		        			<div class="row">
		        				...
		        				<label class="col-sm-1">
		        					...
		        					@endif
		        					 ...
		        					 style="position: static; opacity: 1;" type="checkbox" name="permissions[]" value="{{ $permission->id }}">{{ $permission->title }}
		        		...
		        		<div class="form-group">
		        			<input class="btn btn-primary btn-sm" type="submit" name="submit" value="ویرایش">
		        		</div>
		        	</form>
