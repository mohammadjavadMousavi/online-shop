      ...
      {{--   <li class="treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/adminpanel/user/"><i class="mdi mdi-toggle-switch-off"></i>لیست</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/adminpanel/role/create"><i class="mdi mdi-toggle-switch-off"></i>ایجاد</a></li>
            <li><a href="/adminpanel/role/"><i class="mdi mdi-toggle-switch-off"></i>لیست</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/adminpanel/category/create"><i class="mdi mdi-toggle-switch-off"></i>ایجاد</a></li>
            <li><a href="/adminpanel/category/"><i class="mdi mdi-toggle-switch-off"></i>لیست</a></li>
            <li><a href="/adminpanel/featuredCategory/"><i class="mdi mdi-toggle-switch-off"></i>ایجاد دسته ویژه</a></li>
         ...
         <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="/adminpanel/brand/create"><i class="mdi mdi-toggle-switch-off"></i>ایجاد</a></li>
              <li><a href="/adminpanel/brand/"><i class="mdi mdi-toggle-switch-off"></i>لیست</a></li>
         ...
         <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="/adminpanel/product/create"><i class="mdi mdi-toggle-switch-off"></i>ایجاد</a></li>
              <li><a href="/adminpanel/product/"><i class="mdi mdi-toggle-switch-off"></i>لیست</a></li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="/adminpanel/propertyGroup/create"><i class="mdi mdi-toggle-switch-off"></i>ایجاد</a></li>
              <li><a href="/adminpanel/propertyGroup/"><i class="mdi mdi-toggle-switch-off"></i>لیست</a></li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="/adminpanel/property/create"><i class="mdi mdi-toggle-switch-off"></i>ایجاد</a></li>
              <li><a href="/adminpanel/property/"><i class="mdi mdi-toggle-switch-off"></i>لیست</a></li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="/adminpanel/slide/create"><i class="mdi mdi-toggle-switch-off"></i>ایجاد</a></li>
              <li><a href="/adminpanel/slide/"><i class="mdi mdi-toggle-switch-off"></i>لیست</a></li>
           ...
           <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="{{ route('offer.create') }}"><i class="mdi mdi-toggle-switch-off"></i>ایجاد</a></li>
                  <li><a href="{{ route('offer.index') }}"><i class="mdi mdi-toggle-switch-off"></i>لیست</a></li>
  ...
  <div class="content-wrapper">
	...
	<div class="content-header">
		<div class="d-flex align-items-center">
			<div class="mr-auto">
				<h3 class="page-title">Dashboad</h3>
